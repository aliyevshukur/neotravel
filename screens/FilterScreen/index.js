...
export const FilterScreen = () => {
    ...
    return (
        <View style={styles.container}>
            {modal ? <SelectAlert selectInfo={{title: DATA[selectProcess].name, selectables: DATA[selectProcess].selectables}}
                        selectResult={selected => setUserChoices({... userChoices, [selectProcess]: selected})}
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={styles.filterItem}>
                            <CustomText style={styles.filterItemTitle}>{item.name}</CustomText>
                            {item.selectables ? 
                            <TouchableOpacity style={styles.selectTouch} onPress={() => selectHandler(item.fieldId)}>
                                <CustomText style={styles.selectText}>{userChoices[item.fieldId] || "Select"}</CustomText>
                                {userChoices[item.fieldId] ? null : <CustomSvg name={'chevronRight'} style={styles.chevronRight}/> }
                            </TouchableOpacity>
                            :
